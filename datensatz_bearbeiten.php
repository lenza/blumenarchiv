...
require_once './includes/inc.function.zeige_Datensatz_bearbeiten.php';
...
zeige_Datensatz_bearbeiten( $conn, $datensatz_id, $suchbegriff, 'Details' );
zeige_HTML_Ende();
